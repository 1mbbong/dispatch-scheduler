...
export default function LoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Server sets cookie via Set-Cookie header now.
            // document.cookie line removed.
            console.log('Login successful, redirecting...');

            // Force hard navigation to ensure new cookie is processed
            window.location.href = '/calendar/week';

        } catch (err: any) {
            console.error('Login error:', err);
            setError(err.message);
            // Optional: alert for visibility if UI update is missed
            ...
            <div className="w-full max-w-md space-y-8 rounded-xl bg-white p-10 shadow-lg">
                <div className="text-center">
                    ...
                    <p className="mt-2 text-sm text-gray-600">
                        For demo: Use <b>admin@demo.com</b> / <b>password123</b>
                    </p>
                </div>
